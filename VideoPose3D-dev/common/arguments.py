...
def parse_args():
    ...
    # General arguments
    parser.add_argument('-d', '--dataset', default='egopose', type=str, metavar='NAME', help='target dataset') # h36m or humaneva
    ...
    parser.add_argument('-c', '--checkpoint', default='checkpointNoneCentered', type=str, metavar='PATH',
    ...
    parser.add_argument('--render', action='store_true', help='visualize a particular video',default=True)
    parser.add_argument('--by-subject', action='store_true', help='break down error by subject (on evaluation)')
    parser.add_argument('--export-training-curves', action='store_true', help='save training curves as .png images')

    # Model arguments
    parser.add_argument('-s', '--stride', default=1, type=int, metavar='N', help='chunk size to use during training')
    parser.add_argument('-e', '--epochs', default=0, type=int, metavar='N', help='number of training epochs')
    ...
    parser.add_argument('--downsample', default=0, type=int, metavar='FACTOR', help='downsample frame rate by factor (semi-supervised)')
    ...
    # Visualization
    parser.add_argument('--viz-subject', type=str, metavar='STR', help='subject to render',default=True)
    parser.add_argument('--viz-action', type=str, metavar='STR', help='action to render',default=True)
    parser.add_argument('--viz-camera', type=int, default=0, metavar='N', help='camera to render')
    parser.add_argument('--viz-video', type=str, metavar='PATH', help='path to input video',default='/media/zlz422/jyt/VideoPose3D-dev/images/')
    parser.add_argument('--viz-skip', type=int, default=0, metavar='N', help='skip first N frames of input video' )
    parser.add_argument('--viz-output', type=str, metavar='PATH', help='output file name (.gif or .mp4)',default='/media/zlz422/jyt/VideoPose3D-dev/reslut.mp4')
